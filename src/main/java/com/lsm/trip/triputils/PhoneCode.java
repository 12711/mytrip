...
/**
 * Created by lv on 2017/5/5.
 * 短信验证码
 */
public class PhoneCode {
        public static void sendCode(String phone,String code,String userName) {
            ...
            String username = "15197867623";  //用户名

            String password_md5 = "8cd8265879604fadb5da318bd9cf66b4";  //密码

            String mobile = phone;  //手机号,只发一个号码：13800000001。发多个号码：13800000001,13800000002,...N 。使用半角逗号分隔。

            String apikey = "9053af6d468b4490ec9f0479bd09dc89";  //apikey秘钥（请登录 http://m.5c.com.cn 短信平台-->账号管理-->我的信息 中复制apikey）

            String content = "您好，您正在尝试修改"+userName+"的密码,您的验证码是："+code+"[中国家庭互助旅游]";  //要发送的短信内容，特别注意：签名必须设置，网页验证码应用需要加添加【图形识别码】。
