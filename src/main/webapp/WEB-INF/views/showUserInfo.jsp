        ...
        <div class="tabbable" id="tabs-637123">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="panel-772339" style="height: 300px">
                    <div class="col-sm-7">
                        <form action="${pageContext.request.contextPath}/user/inter/updateUserInfo" method="post">
                            <div class="col-sm-12" style="margin-top: 20px"><span>用户名</span><input class="form-control" type="text"
                                                                          name="userName"
                                                                          value="${userInfo.userName}"></div>
                            <div class="col-sm-12" style="margin-top: 20px"><span>真实姓名</span><input class="form-control" type="text"
                                                                           name="realName"
                            ...
                            <div class="col-sm-12" style="margin-top: 20px"><span>生日</span><input class="form-control" type="text"
                            ...
                            <div class="col-sm-12" style="margin-top: 20px"><span>工作地址</span><input class="form-control" type="text"
                                                                           name="workAddress"
                ...
                <div class="tab-pane" id="panel-568573" style="height: 300px">
                            <form class="form-horizontal" id="pwdUpdate" role="form" style="margin-top: 20px" action="/user/inter/updateuser" method="post">
                                <div class="form-group">
                                    <label for="old" class="col-sm-2 control-label">请输入原来的密码:</label>
                                    <div class="col-sm-10">
                                      <input class="form-control" style="width:400px"  type="password" id="old" placeholder="请输入原来密码">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="new" class="col-sm-2 control-label">请输入新密码:</label>
                                    <div class="col-sm-10">
                                        <input type="text" style="width:400px"  class="form-control" name="passWord" id="new" placeholder="请输入新密码">
                                    </div>
                                </div>
                                <div class="form-group">
