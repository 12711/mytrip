    ...
    <script type="text/javascript">
        $(function () {
            ...
            uploader = WebUploader.create({
                ...
                // 文件接收服务端。
                server: '${pageContext.request.contextPath}/hourse/addHourseImg',
            ...
            $("#ctlBtn").click(function () {
                ...
                console.dir(list)
               //此UID为住房ID
                uploader.options.formData.uid = '${hid}';
                uploader.upload();
            });
...
<div class="container" style="min-height: 500px">
    <div class="row">
        ...
        <div class="col-sm-10"
            ...
            <div class="col-sm-4" style="margin-left: 50px;"><span
                    style="text-shadow: 1px 1px 1px rgba(0,0,0,.2);font-size: 20px;"><h3>添加住房照片</h3></span>
            </div>
